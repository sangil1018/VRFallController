...
| 장비 | IP 주소 | 설명 |
|------|---------|------|
| PC (컨트롤러) | 192.168.0.100 | 고정 IP 권장 |
| 피코4 #1 | 192.168.0.101 | 고정 IP 필수 |
| 피코4 #2 | 192.168.0.102 | 고정 IP 필수 |
| 피코4 #3 | 192.168.0.103 | 고정 IP 필수 |
| 시뮬레이터 | 192.168.0.200 | 고정 IP 권장 |
...
물리적으로 구분하기 쉽도록:
- 피코4 #1 (192.168.0.101) → 빨간색 스티커
- 피코4 #2 (192.168.0.102) → 파란색 스티커
- 피코4 #3 (192.168.0.103) → 초록색 스티커
