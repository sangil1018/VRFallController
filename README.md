...
**권장 IP 구성:**
- PC: `192.168.0.100`
- Pico 4 #1: `192.168.0.101`
- Pico 4 #2: `192.168.0.102`
- Pico 4 #3: `192.168.0.103`
- 시뮬레이터: `192.168.0.200`
...
> ✨ **브라우저 자동 실행**: 서버가 시작되면 자동으로 웹 브라우저에서 접속합니다!

또는 수동으로 웹 브라우저에서 **http://localhost:8000** 접속
